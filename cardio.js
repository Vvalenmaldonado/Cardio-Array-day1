...
//Algo de data con lo que nosotros trabajaremos.
...
'Baddoes, Mick','Beecher, Henry', 'Beethoven, Ludwig','Begin, Menachem',
...
//1.Filter the lsit of inventors for those who where bron in the 1500
...
const oldest = inventors.sort(function(a,b){ 
    const fGuy = a.passed - a.passed;
    const lGuy = b.passed - b.year;
    return fGuy > lGuy ? -1 : 1;
})
console.table(oldest)

//6.Create a list of beolevards in Paris that contain 'de' anywhere in the name
//https://en.wikipedia.org/wiki/Category:Boulevards_in_Paris

/*const category = document.querySelector('.mw-category');
const links = category.querySelectorAll('a');
const de = Array.from(links).map(e=>e.innerText).filter(e=>e.includes('de'));*/
